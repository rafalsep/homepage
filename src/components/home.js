...
const Home = () => {
  ...
  return (
    <BackgroundImage fluid={data.desktop.childImageSharp.fluid} loading="eager">
      <section className="min-h-screen bg-cover w-full bg-center bg-no-repeat flex items-center relative">
        <div className="content text-center md:text-left w-full p-10 md:flex md:flex-row-reverse">
          ...
          <div className="flex-1">
            <h1 className="font-semibold py-12">
              Hello, I&apos;m <div className="text-lime-500 inline-block hover:animate-rubber">R</div>afal
              <div>
            ...
            <div className="max-w-[12rem] mt-4 mx-auto md:ml-0 w-screen mb-12">
              <ul className="flex justify-center md:justify-start items-center">
                <li>
                  <a href="https://github.com/rafalsep">
                ...
                <li className="pl-5">
                  <a href="https://www.linkedin.com/in/rafalsep">
                ...
                <li className="pl-5">
                  <a href="mailto:szczepankiewicz.rafal@gmail.com">
                ...
                <li className="pl-5">
                  <a href="https://twitter.com/rafalsep">
        ...
        <div className="w-[41px] h-[30px] absolute left-[calc(50%_-_20px)] bottom-4">
          <svg className="w-[41px] h-[30px] fill-[#ffffff] rotate-180" viewBox="45.87 4.75 111.491 192.633" role="presentation">
            <g>
