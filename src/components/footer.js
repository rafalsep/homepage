    ...
    <TransitionGroup component={null}>
      {showAnimation && (
        <CSSTransition classNames="fade-down" timeout={0}>
          <footer className="bg-zinc-800" style={{ transitionDelay: `500ms`, transitionDuration: '300ms' }}>
            <div className="max-w-[12rem] mt-0 mx-auto w-screen py-5">
            ...
            <div className="pb-5 px-5 text-center">
              <a href="https://github.com/rafalsep/homepage">Designed &amp; Created by Rafal Szczepankiewicz</a>
            </div>
          </footer>
        </CSSTransition>
      )}
