  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      <div className="absolute z-0 w-screen h-screen">
        <StaticImage className="w-screen h-screen" loading="eager" layout="fullWidth" src="../../images/background.webp" alt="Digital Experience Preview" />,
      </div>
      <div className="z-10 relative overflow-hidden">
        ...
        <section className={`bg-cover w-full bg-center bg-no-repeat flex items-center relative ${styles.content}`}>
          <div className="content text-center md:text-left w-full p-10 md:flex md:flex-row-reverse">
            <TransitionGroup component={null}>
              {showAnimation && (
                <CSSTransition classNames="fade-up" timeout={0}>
                  <div className="grid justify-center md:-mt-12 relative" style={{ transitionDelay: `700ms`, transitionDuration: '300ms' }}>
                    <div
                    ...
                    />
                    <StaticImage
                      className="w-48 h-48 md:w-60 md:h-60 lg:w-72 lg:h-72 xl:w-80 xl:h-80"
            ...
            <div className="flex-1">
              <TransitionGroup component={null}>
                {showAnimation && (
                  <CSSTransition classNames="fade-up" timeout={0}>
                    <h1 className="font-semibold py-12 bg-transparent" style={{ transitionDelay: `600ms`, transitionDuration: '300ms' }}>
                      Hello, I&apos;m{' '}
              ...
              <TransitionGroup component={null}>
                {showAnimation && (
                  <CSSTransition classNames="fade-up" timeout={0}>
                    <div style={{ transitionDelay: `500ms`, transitionDuration: '300ms' }}>
          ...
          <TransitionGroup component={null}>
            {showAnimation && (
              <CSSTransition classNames="fade-up" timeout={0}>
                <div className="w-10 h-8 absolute left-[calc(50%_-_20px)] bottom-10" style={{ transitionDelay: `400ms`, transitionDuration: '300ms' }}>
